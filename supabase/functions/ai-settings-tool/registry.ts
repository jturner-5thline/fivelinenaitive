...
export const REGISTRY: ToolEntry[] = [
  ...
  },
  {
    ...
    apply_mutation: (ctx, value) => setCompanySettingsValue(ctx, ["deal_info","fees","retainer_enabled"], value),
  ...
  },
  {
    ...
    apply_mutation: (ctx, value) => setCompanySettingsValue(ctx, ["deal_info","fees","milestone_enabled"], value),
  ...
  },
  {
    ...
    apply_mutation: (ctx, value) => setCompanySettingsValue(ctx, ["deal_info","fees","total_fee_computed_only"], value),
