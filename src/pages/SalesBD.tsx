            ...
            <TabsContent value="channels">
              <div className="space-y-6">
                ...
                <div className="border-t border-border/30 pt-6">
                  {/* Sub-navigation */}
                  <div className="flex items-center gap-1 mb-5 bg-[hsl(260,20%,14%,0.5)] backdrop-blur-xl border border-[hsl(260,30%,45%,0.1)] ring-1 ring-inset ring-white/[0.03] rounded-lg p-0.5 w-fit shadow-[0_2px_8px_hsl(0,0%,0%,0.2)]">
                    <button
