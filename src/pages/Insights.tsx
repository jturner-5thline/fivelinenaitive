...
function MetricsInner() {
  ...
  const unifiedLayoutDefaults = useMemo(() => {
    const defaults: import('@/hooks/useGridLayout').GridLayoutItem[] = [
      // Row 1
      { i: 'total-revenue-detail', x: 0, y: 0,  w: 3, h: 4, minW: 3, minH: 4, maxH: 4 },
      ...
      { i: 'exec-deals-by-status', x: 6, y: 6,  w: 3, h: 4, minW: 3, minH: 4, maxH: 4 },
  ...
  } = useUserGridLayout('management-snapshot-unified-v25', unifiedLayoutIds, {
