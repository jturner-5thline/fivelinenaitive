...
function MetricsInner() {
  ...
  const unifiedLayoutDefaults = useMemo(() => {
    const defaults: import('@/hooks/useGridLayout').GridLayoutItem[] = [
      // Row 1
      { i: 'total-revenue-detail', x: 0, y: 0,  w: 3, h: 3, minW: 3, minH: 3, maxH: 3 },
      ...
      { i: 'exec-deals-by-status', x: 6, y: 6,  w: 3, h: 3, minW: 3, minH: 3, maxH: 3 },
  ...
  } = useUserGridLayout('management-snapshot-unified-v24', unifiedLayoutIds, {
