          ...
          <div className="space-y-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">Knowledge base, guides, and support</p>
              </div>
            ...
            <Tabs defaultValue="guides" className="space-y-6">
              <TabsList>
                <TabsTrigger value="guides" className="gap-1.5">
                  <PlayCircle className="h-3.5 w-3.5" /> Guides & FAQ
                </TabsTrigger>
              ...
              <TabsContent value="knowledge">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Search articles and documentation</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <KnowledgeBaseSection onArticleClick={setSelectedArticle} />
                  </CardContent>
                </Card>
              </TabsContent>
                ...
                <Card className="bg-muted/30">
                  <CardContent className="pt-6">
                    <div className="text-center space-y-4">
                      <h3 className="font-medium">Need direct help?</h3>
