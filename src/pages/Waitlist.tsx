    ...
    <RateLimitGuard path="/">
      ...
      <div className="min-h-screen bg-[#010114] relative overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-end pb-16 md:pb-24 px-4 animate-fade-in">
          <h1 className="absolute top-[-5%] left-1/2 -translate-x-1/2 text-[22.5vw] font-bold text-white/[0.07] tracking-tighter whitespace-nowrap pointer-events-none select-none">
            nAItive
          </h1>
