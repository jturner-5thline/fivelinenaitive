...
export default function CrmCompanyDetail() {
  ...
  const { data: activities = [] } = useCrmCompanyActivities(id);
    ...
    <>
      ...
      <div className="bg-background min-h-screen">
        <div className="container mx-auto py-6 px-4 space-y-6">
          <Button variant="ghost" size="sm" onClick={() => navigate('/crm-companies')} className="gap-1.5"><ArrowLeft className="h-4 w-4" /> Companies</Button>
