...
export default function Dashboard() {
  ...
  // NOTE: the board scroller previously used a mask-image edge fade driven by
  // a scroll listener. That forced a full-surface repaint on every scroll
  // frame (and a React state update), which made scrolling feel laggy.
  ...
  return (
    <>
      ...
      */}
      <WorkspacePage
        mainClassName="flex min-h-0 flex-col pb-0 pt-1"
              ...
              <DropdownMenu>
                <TooltipTrigger asChild>
                  <DropdownMenuTrigger asChild>
                    <Button variant="outline" size="sm" className="gap-1.5 rounded-md h-9" aria-label="Actions">
      ...
      >
            ...
            >
              <div className="flex flex-wrap items-center gap-2">
                ...
                <div className="relative self-center -ml-4 mr-2">
                  <DealSavedViewsMenu
                    views={savedViews}
