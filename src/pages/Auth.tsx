    ...
    <>
      ...
      <div className="min-h-screen bg-[#010114] relative overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-end pb-4 md:pb-6 px-4">
          <div className="absolute top-[15%] left-1/2 -translate-x-1/2 pointer-events-none select-none flex flex-col items-center">
            <img 
              src={naitiveLogoFull} 
              alt="naitive" 
              className="w-[75vw] max-w-[900px] animate-fade-in"
            />
          </div>
