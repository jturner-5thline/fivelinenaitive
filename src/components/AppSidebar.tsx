  ...
  return (
    <Sidebar side="left" collapsible="icon" data-tour="sidebar">
      ...
      <SidebarHeader
        ...
        className="relative overflow-hidden px-2 py-3 rounded-t-[11px] rounded-b-lg border-b text-foreground opacity-100 shadow-none before:content-none before:hidden group-data-[effective-state=collapsed]:px-0"
      >
