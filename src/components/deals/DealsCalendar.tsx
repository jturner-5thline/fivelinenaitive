...
import { Calendar as CalendarIcon, ChevronLeft, ChevronRight, CheckCircle2, Circle, AlertCircle, ChevronDown, ChevronUp } from 'lucide-react';
...
export function DealsCalendar({ defaultOpen = true }: DealsCalendarProps) {
