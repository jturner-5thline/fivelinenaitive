    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={cn(
          ...
          'popup-shell-surface dashboard-popup-surface w-[min(95vw,1600px)] max-w-[95vw] h-[min(92dvh,1000px)] max-h-[92dvh] p-0 overflow-hidden rounded-2xl border-transparent',
