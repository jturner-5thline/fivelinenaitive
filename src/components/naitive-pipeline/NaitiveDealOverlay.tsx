  ...
  const overlay = (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute top-2 right-2 z-[60] flex items-center gap-1.5 rounded-lg border-0 bg-transparent p-1 shadow-none"
        >
          ...
          <div className="flex md:hidden items-center rounded-lg border border-[rgba(180,212,255,0.42)] bg-[#FFFDF8] shadow-[0_2px_10px_-4px_rgba(0,0,0,0.6)] overflow-hidden">
            <button
              type="button"
              onClick={goPrev}
              disabled={!prevDeal}
            ...
            <span aria-hidden className="h-6 w-px bg-[rgba(180,212,255,0.42)]" />
            <button
              type="button"
              onClick={goNext}
              disabled={!nextDeal}
          ...
          <button
            ref={closeBtnRef}
            type="button"
            className="inline-flex h-11 w-11 items-center justify-center rounded-lg border border-[rgba(180,212,255,0.42)] bg-[#FFFDF8] text-foreground shadow-[0_2px_10px_-4px_rgba(0,0,0,0.6)] transition-colors hover:border-[rgba(180,212,255,0.72)] hover:bg-[#101836] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0"
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              animateClose();
