...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  if (collapsible === "none") {
    return (
      <div
        className={cn("flex h-full w-[--sidebar-width] flex-col bg-sidebar/70 dark:bg-sidebar/60 text-sidebar-foreground", className)}
        ref={ref}
        {...props}
      >
        {children}
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed top-[67px] z-30 hidden h-[calc(100svh-86px)] transition-[left,right,width] duration-150 ease-out md:flex",
          ...
          state === "collapsed" && !isHovering
            ...
            : "w-[--sidebar-width]",
          side === "left"
            ? "left-[6px] group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]"
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button relative flex w-full items-center gap-2 overflow-hidden rounded-md p-2.5 px-4 text-left text-sm outline-none ring-sidebar-ring transition-all duration-[150ms] ease-out disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 text-foreground [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-foreground [&>span:last-child]:truncate hover:bg-[rgba(255,255,255,0.04)] hover:text-foreground hover:[&>svg]:text-foreground focus-visible:ring-2 focus-visible:bg-[rgba(255,255,255,0.04)] focus-visible:text-foreground data-[active=true]:bg-[rgba(126,184,247,0.08)] data-[active=true]:text-primary data-[active=true]:font-medium data-[active=true]:[&>svg]:text-primary data-[state=open]:hover:bg-[rgba(255,255,255,0.04)] data-[state=open]:hover:text-foreground before:content-[''] before:absolute before:left-0 before:top-1 before:bottom-1 before:w-0 before:rounded-full before:bg-primary before:shadow-[0_0_12px_rgba(126,184,247,0.4)] before:opacity-0 before:transition-all before:duration-[150ms] before:ease-out hover:before:w-[3px] hover:before:opacity-60 data-[active=true]:before:w-[3px] data-[active=true]:before:opacity-100 group-data-[effective-state=collapsed]:before:!hidden group-data-[effective-state=collapsed]:!size-9 group-data-[effective-state=collapsed]:!rounded-md group-data-[effective-state=collapsed]:!border group-data-[effective-state=collapsed]:!border-transparent group-data-[effective-state=collapsed]:hover:!border-[rgba(255,255,255,0.12)] group-data-[effective-state=collapsed]:!p-0 group-data-[effective-state=collapsed]:!justify-center group-data-[effective-state=collapsed]:!gap-0 group-data-[effective-state=collapsed]:!mx-auto group-data-[effective-state=collapsed]:data-[active=true]:!rounded-md group-data-[effective-state=collapsed]:data-[active=true]:!shadow-none",
  {
    variants: {
      variant: {
        default: "",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-[rgba(255,255,255,0.04)]",
      },
      size: {
        default: "h-9 text-sm",
        sm: "h-7 text-xs",
