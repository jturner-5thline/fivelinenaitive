    ...
    >
      ...
      >
        <div
          ...
          data-effective-state={effectiveState}
          className={cn(
            "flex h-full w-full flex-col rounded-xl border overflow-hidden transition-all duration-200 border-border dark:border-[hsl(263,45%,45%,0.7)] dark:shadow-[0_0_20px_hsl(263,60%,50%,0.12)]",
            "bg-background",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button relative flex w-full items-center gap-2 overflow-hidden rounded-none p-2.5 px-4 text-left text-sm outline-none ring-sidebar-ring transition-all duration-[120ms] ease-out disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 text-[hsl(260,12%,67%)] [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-[hsl(260,16%,59%)] [&>span:last-child]:truncate hover:bg-[hsl(270,50%,92%,0.12)] hover:text-[hsl(270,100%,96%)] hover:[&>svg]:text-[hsl(270,100%,88%)] focus-visible:ring-2 focus-visible:bg-[hsl(270,50%,92%,0.12)] focus-visible:text-[hsl(270,100%,96%)] data-[active=true]:bg-[hsl(270,60%,85%,0.15)] data-[active=true]:text-[hsl(270,100%,96%)] data-[active=true]:font-medium data-[active=true]:[&>svg]:text-[hsl(270,100%,88%)] data-[state=open]:hover:bg-[hsl(270,50%,92%,0.12)] data-[state=open]:hover:text-[hsl(270,100%,96%)] before:content-[''] before:absolute before:left-0 before:top-1 before:bottom-1 before:w-0 before:rounded-full before:bg-gradient-to-b before:from-[hsl(295,100%,73%)] before:to-[hsl(280,100%,60%)] before:shadow-[0_0_16px_rgba(197,87,255,0.8)] before:opacity-0 before:transition-all before:duration-[120ms] before:ease-out hover:before:w-[3px] hover:before:opacity-100 data-[active=true]:before:w-[3px] data-[active=true]:before:opacity-100",
  {
    variants: {
      variant: {
        default: "",
