  ...
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        ...
        "z-[1400] pointer-events-none select-none overflow-hidden rounded-md border border-[var(--hairline-strong)] bg-popover px-2 py-1 text-[12px] font-medium leading-tight text-popover-foreground shadow-sm subpixel-antialiased [transform:translateZ(0)]",
