...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:scale-[1.02] active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "relative overflow-hidden border border-[hsl(199,80%,50%,0.6)] bg-[linear-gradient(145deg,hsl(199,70%,35%,0.8)_0%,hsl(210,60%,28%,0.85)_50%,hsl(220,50%,22%,0.9)_100%)] text-white font-medium backdrop-blur-xl shadow-[inset_0_1px_1px_hsl(199,80%,70%,0.3),0_4px_20px_hsl(199,70%,30%,0.3)] hover:border-[hsl(199,80%,55%,0.75)] hover:bg-[linear-gradient(145deg,hsl(199,75%,40%,0.85)_0%,hsl(210,65%,32%,0.9)_50%,hsl(220,55%,26%,0.95)_100%)] hover:shadow-[inset_0_1px_1px_hsl(199,80%,75%,0.35),0_6px_28px_hsl(199,70%,35%,0.4)] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:bg-[linear-gradient(135deg,hsl(199,80%,75%,0.2)_0%,transparent_50%,hsl(199,60%,40%,0.05)_100%)]",
        ...
        "liquid-glass": "relative overflow-hidden border border-[hsl(291,48%,60%,0.45)] bg-[hsl(282,70%,35%,0.25)] text-foreground backdrop-blur-xl shadow-[inset_0_1px_1px_hsl(291,48%,75%,0.3),0_4px_24px_hsl(282,70%,35%,0.35)] hover:bg-[hsl(282,70%,35%,0.4)] hover:border-[hsl(291,48%,60%,0.6)] hover:shadow-[inset_0_1px_1px_hsl(291,48%,80%,0.4),0_6px_32px_hsl(282,70%,35%,0.45)] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:bg-[linear-gradient(135deg,hsl(291,48%,75%,0.25)_0%,transparent_50%,hsl(282,70%,35%,0.1)_100%)]",
      },
      size: {
