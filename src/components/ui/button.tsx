  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:scale-[1.02] active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        "liquid-glass": "relative overflow-hidden border-0 bg-[hsl(270,50%,40%,0.25)] text-foreground backdrop-blur-xl shadow-[inset_0_1px_1px_hsl(270,80%,80%,0.3),0_4px_24px_hsl(270,70%,35%,0.35)] hover:bg-[hsl(270,55%,40%,0.4)] hover:shadow-[inset_0_1px_1px_hsl(270,80%,85%,0.4),0_6px_32px_hsl(270,70%,40%,0.45)] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:bg-[linear-gradient(135deg,hsl(270,80%,80%,0.25)_0%,transparent_50%,hsl(270,70%,55%,0.1)_100%)] after:pointer-events-none after:absolute after:inset-0 after:rounded-[inherit] after:p-[1.5px] after:bg-[linear-gradient(135deg,hsl(270,80%,70%,0.7),hsl(290,70%,55%,0.5),hsl(250,70%,60%,0.4))] after:[mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] after:[mask-composite:exclude]",
      },
      size: {
