  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:scale-[1.02] active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        "liquid-glass": "relative overflow-hidden border border-[hsl(280,85%,65%,0.55)] bg-[hsl(275,80%,40%,0.3)] text-foreground backdrop-blur-xl shadow-[inset_0_1px_1px_hsl(280,85%,75%,0.35),0_4px_24px_hsl(275,80%,45%,0.4)] hover:bg-[hsl(275,80%,45%,0.45)] hover:border-[hsl(280,85%,70%,0.7)] hover:shadow-[inset_0_1px_1px_hsl(280,85%,80%,0.45),0_6px_32px_hsl(275,80%,50%,0.5)] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:bg-[linear-gradient(135deg,hsl(280,85%,75%,0.3)_0%,transparent_50%,hsl(275,80%,40%,0.15)_100%)]",
      },
      size: {
