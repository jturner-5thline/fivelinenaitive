  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:scale-[1.02] active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        "liquid-glass": "relative overflow-hidden border border-[hsl(270,60%,70%,0.3)] bg-[hsl(270,40%,50%,0.15)] text-foreground backdrop-blur-xl shadow-[inset_0_1px_1px_hsl(270,80%,90%,0.25),0_4px_20px_hsl(270,60%,40%,0.2)] hover:bg-[hsl(270,40%,50%,0.25)] hover:border-[hsl(270,60%,70%,0.5)] hover:shadow-[inset_0_1px_1px_hsl(270,80%,90%,0.35),0_6px_28px_hsl(270,60%,40%,0.3)] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:bg-[linear-gradient(135deg,hsl(270,80%,90%,0.2)_0%,transparent_50%,hsl(270,60%,70%,0.05)_100%)]",
      },
      size: {
