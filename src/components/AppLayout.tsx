  ...
  return (
    <SidebarProvider defaultOpen={true} className="h-svh overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden z-0" aria-hidden="true">
        {/* Ambient glow orbs */}
        <div className="absolute -top-20 -left-20 w-[600px] h-[600px] rounded-full opacity-[0.15]" style={{ background: 'radial-gradient(circle, hsl(275,80%,25%) 0%, transparent 70%)' }} />
        <div className="absolute top-[40%] -right-16 w-[500px] h-[500px] rounded-full opacity-[0.12]" style={{ background: 'radial-gradient(circle, hsl(280,85%,65%) 0%, transparent 70%)' }} />
        <div className="absolute -bottom-20 left-[20%] w-[600px] h-[400px] rounded-full opacity-[0.12]" style={{ background: 'radial-gradient(ellipse, hsl(278,80%,50%) 0%, transparent 70%)' }} />
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 900" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="lwFill1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="hsl(275,80%,12%)" stopOpacity="0.8" />
              <stop offset="100%" stopColor="hsl(275,70%,6%)" stopOpacity="0.5" />
            </linearGradient>
            <linearGradient id="lwFill2" x1="100%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="hsl(275,75%,10%)" stopOpacity="0.7" />
              <stop offset="100%" stopColor="hsl(280,60%,5%)" stopOpacity="0.4" />
            </linearGradient>
            <linearGradient id="lwFill3" x1="0%" y1="100%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="hsl(280,70%,12%)" stopOpacity="0.7" />
              <stop offset="100%" stopColor="hsl(275,60%,6%)" stopOpacity="0.4" />
            </linearGradient>
            <linearGradient id="lwEdge1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="hsl(280,85%,72%)" stopOpacity="0.0" />
              <stop offset="30%" stopColor="hsl(280,85%,72%)" stopOpacity="0.7" />
              <stop offset="70%" stopColor="hsl(275,85%,60%)" stopOpacity="0.6" />
              <stop offset="100%" stopColor="hsl(275,85%,60%)" stopOpacity="0.0" />
            </linearGradient>
            <linearGradient id="lwEdge2" x1="100%" y1="0%" x2="0%" y2="0%">
              <stop offset="0%" stopColor="hsl(280,85%,72%)" stopOpacity="0.0" />
              <stop offset="25%" stopColor="hsl(280,85%,72%)" stopOpacity="0.6" />
              <stop offset="75%" stopColor="hsl(275,85%,60%)" stopOpacity="0.55" />
              <stop offset="100%" stopColor="hsl(275,85%,60%)" stopOpacity="0.0" />
            </linearGradient>
            <linearGradient id="lwEdge3" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="hsl(275,85%,60%)" stopOpacity="0.0" />
              <stop offset="20%" stopColor="hsl(275,85%,60%)" stopOpacity="0.55" />
              <stop offset="80%" stopColor="hsl(280,85%,72%)" stopOpacity="0.65" />
              <stop offset="100%" stopColor="hsl(280,85%,72%)" stopOpacity="0.0" />
            </linearGradient>
