  ...
  return (
    <SidebarProvider defaultOpen={true} className="h-svh overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden z-0" aria-hidden="true">
        {/* Ambient glow orbs */}
        <div className="absolute -top-20 -left-20 w-[600px] h-[600px] rounded-full opacity-[0.22]" style={{ background: 'radial-gradient(circle, hsl(270,90%,35%) 0%, transparent 70%)' }} />
        <div className="absolute top-[40%] -right-16 w-[500px] h-[500px] rounded-full opacity-[0.18]" style={{ background: 'radial-gradient(circle, hsl(275,95%,60%) 0%, transparent 70%)' }} />
        <div className="absolute -bottom-20 left-[20%] w-[600px] h-[400px] rounded-full opacity-[0.18]" style={{ background: 'radial-gradient(ellipse, hsl(272,90%,50%) 0%, transparent 70%)' }} />
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1440 900" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="lwFill1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="hsl(270,90%,18%)" stopOpacity="0.9" />
              <stop offset="100%" stopColor="hsl(270,80%,10%)" stopOpacity="0.6" />
            </linearGradient>
            <linearGradient id="lwFill2" x1="100%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="hsl(270,85%,15%)" stopOpacity="0.8" />
              <stop offset="100%" stopColor="hsl(275,70%,8%)" stopOpacity="0.5" />
            </linearGradient>
            <linearGradient id="lwFill3" x1="0%" y1="100%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="hsl(275,85%,16%)" stopOpacity="0.8" />
              <stop offset="100%" stopColor="hsl(270,70%,9%)" stopOpacity="0.5" />
            </linearGradient>
            <linearGradient id="lwEdge1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="hsl(275,95%,75%)" stopOpacity="0.0" />
              <stop offset="30%" stopColor="hsl(275,95%,75%)" stopOpacity="0.8" />
              <stop offset="70%" stopColor="hsl(270,90%,65%)" stopOpacity="0.7" />
              <stop offset="100%" stopColor="hsl(270,90%,65%)" stopOpacity="0.0" />
            </linearGradient>
            <linearGradient id="lwEdge2" x1="100%" y1="0%" x2="0%" y2="0%">
              <stop offset="0%" stopColor="hsl(275,95%,75%)" stopOpacity="0.0" />
              <stop offset="25%" stopColor="hsl(275,95%,75%)" stopOpacity="0.7" />
              <stop offset="75%" stopColor="hsl(270,90%,65%)" stopOpacity="0.65" />
              <stop offset="100%" stopColor="hsl(270,90%,65%)" stopOpacity="0.0" />
            </linearGradient>
            <linearGradient id="lwEdge3" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="hsl(270,90%,65%)" stopOpacity="0.0" />
              <stop offset="20%" stopColor="hsl(270,90%,65%)" stopOpacity="0.65" />
              <stop offset="80%" stopColor="hsl(275,95%,75%)" stopOpacity="0.75" />
              <stop offset="100%" stopColor="hsl(275,95%,75%)" stopOpacity="0.0" />
            </linearGradient>
