...
export function NotificationListView({
  ...
  const renderAlertsSection = () => {
    ...
    return (
      <Collapsible key="alerts" open={openSections.alerts} onOpenChange={() => toggleSection('alerts')}>
  ...
  const renderFlexSection = () => {
    ...
    return (
      <Collapsible key="flex" open={openSections.flex} onOpenChange={() => toggleSection('flex')}>
        <CollapsibleTrigger className="w-full">
  ...
  const renderTasksSection = () => {
    ...
    return (
      <Collapsible key="tasks" open={openSections.tasks} onOpenChange={() => toggleSection('tasks')}>
        <CollapsibleTrigger className="w-full">
  ...
  const renderSuggestionsSection = () => {
    ...
    return (
      <Collapsible key="suggestions" open={openSections.suggestions} onOpenChange={() => toggleSection('suggestions')}>
        <CollapsibleTrigger className="w-full">
          <div className="px-6 py-3 bg-primary/10 sticky top-0 z-10 hover:bg-primary/15 transition-colors cursor-pointer">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-sm font-semibold text-primary">
          ...
          <div className="divide-y">
            {suggestions.map((suggestion) => {
              ...
              return (
                ...
                >
                  <div className={cn("flex h-11 w-11 items-center justify-center rounded-full flex-shrink-0 mt-0.5", config.bg)}>
  ...
  const renderMilestonesSection = () => {
    ...
    return (
      <Collapsible key="milestones" open={openSections.milestones} onOpenChange={() => toggleSection('milestones')}>
        <CollapsibleTrigger className="w-full">
  ...
  const renderActivitySection = () => {
    ...
    return (
      <Collapsible key="activity" open={openSections.activity} onOpenChange={() => toggleSection('activity')}>
        <CollapsibleTrigger className="w-full">
