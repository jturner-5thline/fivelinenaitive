...
function generateDailyRowStructure(): DailyRowStructure {
  return {
    rows: [
      ...
      { row_num: '20b' as any, label: 'M&T Bank Balance', entity: 'ALL', section: 'balance_begin', is_total: false, is_protected: false, indent: true },
      ...
      { row_num: '25b' as any, label: 'M&T Bank Balance', entity: 'ALL', section: 'balance_end', is_total: false, is_protected: false, indent: true },
