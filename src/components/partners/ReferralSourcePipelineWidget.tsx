      ...
      <div className="grid gap-2 items-start" style={{ gridTemplateColumns: `repeat(${columns.length}, minmax(0,1fr))` }}>
        {columns.map(stage => (
          <div
            ...
            className="rounded-lg border border-[rgba(126,184,247,0.22)] bg-[#FFFDF8] shadow-[inset_0_1px_0_rgba(200,225,255,0.09),0_1px_2px_rgba(0,0,0,0.32),0_12px_32px_-16px_rgba(0,0,0,0.62)] overflow-hidden"
          >
            ...
            <ScrollArea className="h-56">
              <div className="p-1.5 space-y-1.5">
                ...
                {stage.cards.map(card => (
                  <div
                    key={card.id}
                    className="group rounded-md border border-[rgba(126,184,247,0.22)] bg-[#FFFDF8] px-2 py-1.5 hover:bg-[#101836] hover:border-[rgba(126,184,247,0.4)] transition-colors"
                  >
