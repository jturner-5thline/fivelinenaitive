              ...
              <div className="space-y-0.5">
                {dayEvents.slice(0, visibleCount).map(event => (
                  <div
                    ...
                    className="text-[10px] px-1.5 py-0.5 bg-gradient-to-br from-[#01696f] to-[#0c4e54] text-white border-l-2 border-l-[#7ed0d6] rounded-[2px] cursor-pointer hover:brightness-110 truncate transition-all"
                  >
                    {event.summary}
                  </div>
                ))}
