    ...
    <>
      <Tooltip>
        <TooltipTrigger asChild>
          <Button variant="outline" size="icon" aria-label="Create Task" className="relative h-8 w-8 transition-colors duration-200 hover:border-[hsl(292,46%,72%)]/60" onClick={() => setIsOpen(true)}>
