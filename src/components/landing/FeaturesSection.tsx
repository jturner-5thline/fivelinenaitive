    ...
    <section id="features" className="py-20 md:py-32 bg-secondary/30">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-heading md:text-4xl bg-brand-gradient bg-clip-text text-transparent dark:bg-none dark:text-white mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-subheading bg-brand-gradient bg-clip-text text-transparent dark:bg-none dark:text-white mb-2">{feature.title}</h3>
