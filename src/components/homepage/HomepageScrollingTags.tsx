      ...
      <div className="relative">
        ...
        <div className="flex animate-scroll-left">
          {[...tags, ...tags, ...tags].map((tag, index) => (
            <div
              key={index}
              className="flex-shrink-0 px-5 py-2.5 mx-2 rounded-lg bg-gradient-to-b from-[hsl(280,40%,20%,0.3)] to-[hsl(260,30%,12%,0.3)] border border-[hsl(280,60%,45%,0.4)] text-white/80 text-sm whitespace-nowrap pointer-events-none shadow-[0_0_8px_hsl(280,60%,45%,0.1)]"
            >
              {tag}
            </div>
          ))}
