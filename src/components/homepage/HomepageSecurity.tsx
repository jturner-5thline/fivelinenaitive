        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {securityFeatures.map((feature) => (
              <div
                key={feature}
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-[hsl(263,30%,35%,0.5)] text-white/80 text-sm"
              >
          ...
          <div className="flex justify-center gap-6">
            {badges.map((badge) => (
              <div
                key={badge}
                className="px-6 py-3 rounded-lg bg-white/5 border border-[hsl(263,30%,35%,0.5)] text-white font-semibold text-sm"
              >
                {badge}
              </div>
            ))}
