...
const INSIGHTS_DEFAULT_LAYOUT: GridLayoutItem[] = [
  ...
  { i: 'kpi-summary', x: 0, y: 0, w: 6, h: 9, minW: 4, minH: 9 },
  { i: 'ar-aging', x: 6, y: 0, w: 6, h: 6, minW: 3, minH: 3 },
  { i: 'monthly-revenue', x: 0, y: 9, w: 6, h: 4, minW: 4, minH: 3 },
  { i: 'active-deals-list', x: 0, y: 13, w: 12, h: 5, minW: 6, minH: 3 },
  { i: 'liabilities', x: 0, y: 18, w: 4, h: 3, minW: 3, minH: 2 },
  { i: 'dscr', x: 4, y: 18, w: 4, h: 3, minW: 3, minH: 2 },
  { i: 'cashflow-12w', x: 0, y: 21, w: 6, h: 4, minW: 4, minH: 3 },
  { i: 'debt-rating', x: 6, y: 21, w: 6, h: 4, minW: 4, minH: 3 },
  { i: 'asana-goals', x: 0, y: 25, w: 12, h: 6, minW: 6, minH: 4 },
];
...
export function ManagementReviewDashboard({ isEditMode = false, onExitEditMode }: ManagementReviewDashboardProps = {}) {
  ...
  const {
    ...
    saveLayout,
    resetLayout,
  } = useGridLayout('insights-management-review-v8', INSIGHTS_LAYOUT_IDS, {
