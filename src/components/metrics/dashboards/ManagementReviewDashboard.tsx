...
const INSIGHTS_DEFAULT_LAYOUT: GridLayoutItem[] = [
  ...
  { i: 'kpi-summary', x: 0, y: 0, w: 6, h: 6, minW: 4, minH: 6 },
  { i: 'ar-aging', x: 6, y: 0, w: 6, h: 6, minW: 3, minH: 3 },
  { i: 'monthly-revenue', x: 0, y: 6, w: 6, h: 4, minW: 4, minH: 3 },
  ...
  { i: 'cashflow-12w', x: 0, y: 18, w: 6, h: 4, minW: 4, minH: 3 },
...
export function ManagementReviewDashboard({ isEditMode = false, onExitEditMode }: ManagementReviewDashboardProps = {}) {
  ...
  const {
    ...
    saveLayout,
    resetLayout,
  } = useGridLayout('insights-management-review-v7', INSIGHTS_LAYOUT_IDS, {
