  ...
  return (
    <div style={{ background: '#0f1923', color: '#d0dce8', fontFamily: 'system-ui, sans-serif', padding: '14px 0' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0,1fr))', gap: 10, marginBottom: 10 }}>
        <MetricGrid title="Consolidated Revenue" rows={[
        ...
        <MetricGrid title="Consolidated Operating Profit" rows={[
        ...
        <MetricGrid title="Liquidity" rows={[
        ...
        <MetricGrid title="Debt Advisory Operating Profit" rows={[
        ...
        <MetricGrid title="YTD Revenue" rows={[
        ...
        <MetricGrid title="YTD Operating Profit" rows={[
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0,1fr))', gap: 10, marginBottom: 10 }}>
        <MetricGridShort title="Dollars Funded YTD" headers={['Plan','Q1','Q2','Q3','Q4','Total']} rows={[
        ...
        <MetricGridShort title="Deals Closed YTD" headers={['Plan','Q1','Q2','Q3','Q4','Total']} rows={[
        ...
        <MetricGridShort title="Deals Signed YTD" headers={['Plan','Q1','Q2','Q3','Q4','Total']} rows={[
      ...
      {/* Full-width Dollars Signed */}
      <MetricGrid title="Dollars Signed YTD" rows={[
